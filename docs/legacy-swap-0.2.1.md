# Legacy weapon-animation-hotreload (0.2.1)

Historical documentation only. The default 0.3 experimental DLL no longer
executes this feature. See the repository README for the capacity test build.
...
acceptance; see [the 1.17.1 evidence report](compatibility-1.17.1.md).
